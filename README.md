...
- 社区已经有更好的实现, 此项目仅作为mcp first glance的留存, 如要使用, 请用: https://www.npmjs.com/package/@arielbk/anki-mcp
- anki-connect-doc.md是从官网爬过来的, 后续如果要捡起这个项目可以用上
= npm run inspector可以调试mcp插件
